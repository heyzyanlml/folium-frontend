const faqData = [
  {
    ...
    description: `<p  className={styles.AccordionSection__Accordion}>¡No te preocupes! <br/><br> Todos hemos estado ahí: compramos una planta con grandes intenciones de cuidarla, pero entre el ajetreo diario, se nos olvida regar. La buena noticia es que hay plantas súper resistentes que se llevan muy bien con los olvidos ocasionales de riego.  
  <br><br>Aquí van algunas de las mejores opciones para principiantes:</p>

  <br>
   <strong>🌱 Sanfelias (Sansevieria)</strong>: También conocida como 'lengua de suegra', es casi indestructible. Acepta poca agua, luz baja y puede sobrevivir a descuidos prolongados, ¡perfecta para quienes tienen memoria selectiva!   <br>

    <br> <strong>🌱 Cactus</strong>: Estos pequeños guardianes del desierto se adaptan a vivir con poca agua. De hecho, ¡les encanta la sequedad! Solo necesitarás regarlos una vez cada dos semanas (o menos, dependiendo del calor). <br>
    <br> <strong>🌱 Aloe Vera</strong>: Además de ser una planta resistente, tiene la ventaja de que sus hojas suculentas almacenan agua. Un par de riegos semanales son más que suficientes, ¡y hasta te ayudará con las quemaduras solares!   <br>
   <br> <strong>🌱 Pothos (Epipremnum aureum)</strong>: Esta planta trepadora es muy tolerante a la falta de agua. Puedes dejarla por varios días (o semanas) sin que se ponga triste, además de que le encanta colgar y aportar un toque fresco a cualquier espacio.`,
  },
  {
    id: 2,
    number: "02.",
    title: "¿Por qué mi planta tiene hojas caídas?",
    description: `<p> ¡No te preocupes, es normal! Las hojas caídas pueden ser señal de varias cosas, pero generalmente tiene solución. <br><br>Aquí te dejamos los motivos más comunes:</p><br>
  <strong>🔸 Demasiado o poco riego</strong>: Si las hojas están blandas y marchitas, puede ser exceso de agua. Si están secas y crujientes, probablemente necesite más. ¡Encuentra el balance!
<br><br>
  <strong>🔸  Cambio de temperatura</strong>: Si la planta ha sido movida a un lugar con temperatura muy diferente, puede estar estresada. Busca un lugar más estable.
<br><br>
<strong>🔸  Falta de luz</strong>: Si la planta está en un lugar muy oscuro, ¡puede estar pidiendo más luz! Múvela a un lugar más brillante, pero sin sol directo si no le gusta.
<br><br>
 <strong>🔸  Demasiado sol</strong>: Si el sol es muy fuerte, puede quemar las hojas. ¡No todas las plantas son fans del sol directo!
<br><br>
  <strong>🔸  Plagas o enfermedades</strong>: Revisa si hay bichitos o manchas raras. ¡Un buen chequeo puede salvarla!
  <br><br>
  ...
  },
  {
    ...
    description: `<p>¡Entendemos que quieras experimentar con la decoración de tu hogar, pero mover tus plantas demasiado seguido puede estresarlas! <br><br>🌿 Las plantas, al igual que nosotros, prefieren un ambiente estable y predecible.<br> <br>Aquí te contamos por qué:</p>
  <br>
  
   <strong>🔸 Cambio de luz</strong>: Las plantas se adaptan a la cantidad y tipo de luz de su lugar, así que si las mueves de sitio, podrían estar recibiendo más (¡o menos!) luz de la que necesitan. Este cambio puede hacer que sus hojas se pongan amarillas o que no crezcan como deberían.
<br><br>
    <strong>🔸 Estrés por el movimiento</strong>: Las plantas tienen sus raíces bastante establecidas en el lugar donde están, y moverlas de repente puede alterarlas. Este "estrés de mudanza" puede hacer que sus hojas se caigan o que se ralentice su crecimiento.
<br><br>
     <strong>¿Les gusta el cambio?</strong>: Algunas plantas no se sienten tan cómodas con los cambios constantes. Por ejemplo, las plantas de interior como las suculentas y las orquídeas prefieren una ubicación fija donde puedan prosperar. ¡Menos es más!
  <br><br>
  <strong>Entonces, ¿cuándo está bien moverlas?</strong> Si notas que no están recibiendo suficiente luz o si el lugar donde están se vuelve demasiado caluroso o frío, moverlas a un lugar más adecuado es una buena idea. Pero, en general, ¡dale a tu planta un hogar estable y verás cómo te lo agradece!</p>`,
  },
  {
    id: 4,
    number: "04.",
    title: "¿Cómo evito ahogar a mi planta con agua?",
    description: `<p>¡Las plantas son como nosotros, no les gusta sentirse "empapadas"!    <br><br>🌱 Si te preocupa que puedas estar regando demasiado, no te preocupes, ¡aquí estamos para ayudarte a encontrar el balance perfecto!💧</p>
  <br>
 ...
 <br>  <br>
  ...
  <br>  <br>
  ¡Con estos consejos, tu planta estará feliz y saludable, sin riesgo de ahogarse! 🌿   <br>  <br>Si alguna vez dudas, recuerda que es mejor quedarse corto con el agua que excederse. ¡Tus plantas te lo agradecerán! 💧`,
  },
  {
    id: 5,
    number: "05.",
    title: "¿Cuándo debo cambiarle la tierra a mi planta?",
    description: `<p>¡Cambiarle la tierra a tu planta no es solo una excusa para jugar a ser jardinero, es parte de su cuidado!<br><br> 🌱 Aquí te dejamos algunas señales que te indican que es hora de darle un “lavado de cara” a tu planta con tierra fresca:</p>
  <br>
 ...
 <br><br>
  ...
  <br>
    <p>Con estos consejos, ¡tu planta estará lista para un nuevo capítulo con tierra fresca y renovada!  <br><br>🌿 Si la cuidas bien, seguro te lo agradecerá con un montón de hojas verdes. 😊  </p>`,
  },
  {
    id: 6,
    number: "06.",
  ...
  <br>
   <br>
  <strong>✅ Cáscaras de huevo:</strong> Aportan calcio, pero tardan en descomponerse. Tritúralas bien.<br>

  <strong>✅ Café usado:</strong> Enriquece la tierra, pero en exceso puede apelmazarla. No lo uses fresco.<br>
